...
Of course, the former remains a hypothesis requiring further empirical testing. (And if supported, it could open new avenues for language learning and literacy advancement worldwide.) But the latter phenomenon is pretty well established. So, what is to prevent us from adopting ConLangs such as Hesperanto immediately? We can eradicate certain types of problems right away. We only have to commit to doing it.
